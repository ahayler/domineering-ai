...
public class PenguAI extends AI {
    ...
    */
    ...
    private AI MediumAI = new MinMaxAI(2, new ExtendedRealAndSafeMovesEvaluationFunction(), true, true, 5, true);
    private AI HardAI = new MinMaxAI(3, new ExtendedRealAndSafeMovesEvaluationFunction(), true, false, 14, true);
