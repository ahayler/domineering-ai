...
public class PenguAI extends AI {
    ...
    private AI MediumAI = new MinMaxAI(2, new RealAndSafeMovesEvaluationFunction(), true);
    private AI HardAI = new MinMaxAI(2, new RealAndSafeMovesEvaluationFunction(), true);
