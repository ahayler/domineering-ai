...
public class OldReworkedEvaluationFunction extends EvaluationFunction {
    /*
    ...
    */
    ...
    public int[] evaluate(int verticalMobility, int horizontalMobility, int verticalRealMoves, int horizontalRealMoves,
        ...
        return new int[]{verticalRealMoves + verticalSafeMoves
                ...
                (verticalSafeMovePossibilities - verticalDeadMoves)
                        - (horizontalSafeMovePossibilities - horizontalDeadMoves)};
    }
